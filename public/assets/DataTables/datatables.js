 ...
 *   https://datatables.net/download/#dt/dt-1.10.11,b-1.1.2,b-print-1.1.2,r-2.0.2
 *
 * Included libraries:
 *   DataTables 1.10.11, Buttons 1.1.2, Print view 1.1.2, Responsive 2.0.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.11,b-1.1.2,b-print-1.1.2,r-2.0.2",
